      ...
      <section className="relative bg-[#800000] text-white py-20 lg:py-28 overflow-hidden">
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <p className="text-stone-200 text-sm sm:text-base lg:text-lg max-w-3xl mx-auto font-light leading-relaxed">
            Welcome to the Vasant Valley School admissions portal. Learn about eligibility, timelines, application processes, and fee structures for all year groups.
          </p>
          ...
          <div className="pt-4 flex flex-wrap justify-center gap-3">
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all shadow-sm ${
                activeTab === "preschool" ? "bg-white text-[#800000] shadow-lg" : "bg-white/10 text-white hover:bg-white/20"
              }`}
            >
              Pre-School (FDN)
            </button>
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all shadow-sm ${
                activeTab === "class1to7" ? "bg-white text-[#800000] shadow-lg" : "bg-white/10 text-white hover:bg-white/20"
              }`}
            >
              Class 1 to 7
            </button>
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all shadow-sm ${
                activeTab === "class11" ? "bg-white text-[#800000] shadow-lg" : "bg-white/10 text-white hover:bg-white/20"
              }`}
            >
              Class XI (AS Levels)
            </button>
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all shadow-sm ${
                activeTab === "fee" ? "bg-white text-[#800000] shadow-lg" : "bg-white/10 text-white hover:bg-white/20"
              }`}
            >
              Fee Structure
            </button>
