...
export default function Announcement() {
  ...
  return (
    <section className="w-full font-sans bg-[#F9F8F6] text-stone-900 pb-16">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 mt-20 pt-10 border-t border-stone-200/70">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-full border-2 border-[#800000] text-[#800000] flex items-center justify-center shrink-0">
              <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
            </div>
            <div>
              <h4 className="text-sm font-bold text-stone-900">Holistic Education</h4>
              <p className="text-xs text-stone-500 mt-1">Nurturing mind, body and character.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-stone-900">Global Perspective</h4>
              <p className="text-xs text-stone-500 mt-1">Preparing students to be global citizens.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-stone-900">Safe Environment</h4>
              <p className="text-xs text-stone-500 mt-1">A secure and inclusive space to learn and grow.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-stone-900">Excellence Driven</h4>
              <p className="text-xs text-stone-500 mt-1">Committed to excellence in all we do.</p>
            </div>
          </div>
