        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-white p-6 rounded-2xl border border-stone-200 shadow-sm space-y-4">
            ...
            <div className="pt-1">
              <a
                href="/learning-experience"
                className="inline-flex items-center gap-2 bg-[#800000] hover:bg-[#600010] text-white px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm transition-all"
              >
